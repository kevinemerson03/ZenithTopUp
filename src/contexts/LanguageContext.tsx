...
const translations: Translations = {
  en: {
    ...
    'legal.subtitle': 'Transparency and Security at Zenith',
    'partners.title': 'Official Zenith Partners',
    'partners.subtitle': 'Collaborating for Mutual Growth',
    ...
    'faq.subtitle': 'Find quick answers to common technical queries',
  },
  id: {
    'nav.home': 'Beranda',
    'nav.history': 'Riwayat',
    ...
    'legal.title': 'Pusat Hukum',
    'legal.subtitle': 'Transparansi dan Keamanan di Zenith',
    'partners.title': 'Mitra Resmi Zenith',
    'partners.subtitle': 'Kolaborasi untuk Pertumbuhan Bersama',
    'nav.partners': 'Mitra',
    ...
    'faq.subtitle': 'Temukan jawaban cepat untuk kendala teknis Anda',
  }
};
